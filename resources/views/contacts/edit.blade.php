...
<head>
    ...
    <title>Edit Contact - Sales CRM</title>
    ...
    <div class="min-h-screen flex">
        ...
        <div class="flex-1 flex flex-col">
            <header class="bg-white border-b border-gray-200 px-6 py-4 flex justify-between items-center">
                <div><h2 class="text-xl font-semibold text-gray-800">Edit Contact</h2></div>
            ...
            <main class="p-6 bg-gray-50">
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                    <form action="{{ route('agent.contacts.update', $contact) }}" method="POST">
                        @csrf
                        @method('PUT')
                        @if($errors->any())
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select name="source" id="source" required class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                    ...
                                    <option value="{{ $source }}" {{ old('source', $contact->source) == $source ? 'selected' : '' }}>{{ ucfirst($source) }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="mt-6">
                            ...
                            <input type="text" name="tags_input" id="tags_input" placeholder="Enter tags separated by commas" value="{{ old('tags_input', $contact->tags ? implode(', ', $contact->tags) : '') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                        ...
                        <div class="flex justify-end gap-3 mt-8">
                            ...
                            <button type="submit" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 font-medium">Update Contact</button>
                        </div>
                    </form>
                </div>
            </main>
