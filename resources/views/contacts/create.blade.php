    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        <form action="{{ route($routePrefix . '.contacts.store') }}" method="POST">
            ...
            <div class="mt-6">
                ...
                <input type="text" name="tags_input" id="tags_input" placeholder="{{ __('messages.common.tags_placeholder') }}" value="{{ old('tags_input', '') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
            ...
            <div class="flex justify-end gap-3 mt-8">
                ...
                <button type="submit" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 font-medium">{{ __('messages.contacts.new_contact') }}</button>
            </div>
        </form>
    </div>
@endsection
