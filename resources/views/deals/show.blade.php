    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div class="lg:col-span-2 space-y-6">
                <div class="bg-white rounded-xl shadow-sm p-6">
                    <div class="flex items-center justify-between mb-4">
                        <h2 class="text-lg font-semibold text-gray-800">Deal Information</h2>
                    ...
                    <dl class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <dd class="text-gray-800">{{ $deal->expected_close_date?->format('M d, Y') ?? 'Not set' }}</dd>
                        </div>
                        <div>
                            <dt class="text-sm text-gray-500">Days in Stage</dt>
                            <dd class="text-gray-800">{{ $deal->daysInStage() }} days</dd>
                        </div>
                        @if($deal->lost_reason)
                        <div class="col-span-2">
                            <dt class="text-sm text-gray-500">Lost Reason</dt>
                ...
                <div class="bg-white rounded-xl shadow-sm p-6">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500">{{ $deal->contact->company ?? 'No company' }}</p>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-xl shadow-sm p-6">
                    <h2 class="text-lg font-semibold text-gray-800 mb-4">Pipeline</h2>
                    <p class="text-sm text-gray-500 mb-3">Expected Value: <span class="font-semibold text-gray-800">{{ $deal->currency }} {{ number_format($deal->value * $deal->probability / 100, 2) }}</span></p>
